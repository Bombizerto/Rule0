...
const OrganizerDashboard = ({ organizerId, onSelectEvent }) => {
    ...
    return (
        <div className="dashboard-container" id="tour-dashboard-main" style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem 1rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    ...
                    <button
                        ...
                        onClick={() => {
                            localStorage.removeItem('rule0_tour_completed');
                            setRunTour(true);
                        }}
                    >
                        ¿Ayuda / Tutorial?
            ...
            <div id="tour-events-grid" style={{ minHeight: '200px' }}>
                {events.length === 0 ? (
                    <div style={{ textAlign: 'center', padding: '3rem', color: 'var(--text-muted)', background: 'var(--surface)', borderRadius: '12px', border: '1px dashed var(--border)' }}>
                        <p>No tienes ningún torneo registrado todavía. ¡Crea el primero!</p>
                    </div>
                ) : (
